...
import { Calculate, objT } from "../../context/context";
...
const StatComponent = (): JSX.Element => {
  ...
  let Total, todos;
  let check = JSON.stringify(State.Todos) === "{}";
  Total = check ? 0 : Calculate(State?.Todos);
  todos = {
    a: check ? 0 : State.Todos.lifestyle_todos.length - 1,
    b: check ? 0 : State.Todos.business_todos.length - 1,
    c: check ? 0 : State.Todos.personal_todos.length - 1,
  };
  return (
      ...
      {JSON.stringify(State.Todos) === "{}" ? (
        ...
        <div className="p-5 flex flex-col">
          ...
          <div className="flex sm:flex-row flex-col items-center sm:items-stretch w-full gap-5 ">
            <div className="sm:w-4/6 w-full sm:mb-0 mb-7">
              <LineComponent />
            </div>
            <div className="sm:w-2/6 w-full  bg-white rounded-xl shadow grid grid-cols-1 items-start gap-3 p-5">
              <div className="flex flex-row items-start mt-3 gap-5">
                ...
                <div className="flex flex-col items-start ml-2">
                  <p className="font-pop text-lg">Account created</p>
              ...
              <div className="flex flex-row items-start mt-3 gap-5">
                ...
                <div className="flex flex-col items-start ml-2">
                  <p className="font-pop text-lg">Account updated</p>
                  <small className="font-pop font-semibold text-gray-700 items-start">
                    {State.Todos.update}
                  </small>
                </div>
              ...
              <div className="flex flex-row items-start mt-3 gap-5">
                ...
                <div className="flex flex-col items-start ml-2">
                  <p className="font-pop text-lg">Last Activity</p>
                  <small className="font-pop font-semibold text-gray-700 items-start">
              ...
              <div className="flex flex-row items-start mt-3 gap-5">
                ...
                <div className="flex flex-col items-start ml-2">
                  <p className="font-pop text-lg">Active on</p>
                  <small className="font-pop font-semibold text-gray-700 items-start">
                    {State.Todos.clock}
                  </small>
                </div>
          ...
          <div className="p-14 rounded shadow w-full bg-white mt-3"></div>
        </div>
      )}
    </div>
  );
