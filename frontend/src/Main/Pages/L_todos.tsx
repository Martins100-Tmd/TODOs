        ...
        {load.modal === 1 ? (
          ...
          >
            <div className="flex flex-row items-center justify-between w-full border-b border-gray-200 p-4">
              <p className="font-pop text-lg text-left self-start">Lifestyle</p>
              <i
            ...
            <p className="text-base text-left w-full font-pop p-4 max-h-500 inline-block overflow-y-scroll h-auto">
              {load.text}
            </p>
